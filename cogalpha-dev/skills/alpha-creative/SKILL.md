...
2. Plan one financial mechanism aligned to AgentCreative: Nonlinear transformations and novel feature representations.
...
5. Preserve lineage with agent_skill: alpha-creative, generation, and guidance mode so later trace review can attribute outcomes.
...
Runtime traces should be able to record skill_name: alpha-creative, paper_agent_name: AgentCreative, candidate_id, generation, guidance_mode, stage, and evidence_id. Candidate metadata should make utility updates trace-grounded and should not imply prompt promotion without review.
