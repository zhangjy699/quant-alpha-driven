...
Review alpha code for contract compliance, vectorized implementation quality, numerical stability, and practical execution risk before deeper semantic approval. This quality skill converts candidate review into an explicit accept, repair, or reject decision while preserving structured feedback for later agentic traces.
...
Runtime traces should record skill_name: alpha-code-quality, candidate_id, action, verdict, stage, repair_attempt, and evidence_id. Review evidence may update skill utility only after downstream candidate lifecycle and fitness outcomes are observed.
